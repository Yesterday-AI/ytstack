...
- [ ] **`ytstack forget <marker>` command.** Referenced in AskUserQuestion re-ask-anchor footer but not implemented. Build or remove references. (surfaced: M001 T02 init-project design)
